...
from loader_ulub.celebA_dataset import CelebA_HQ
...
def train(
    ...
    # train_dataset = CelebA_HQ(root=os.path.join('/data/dk/ulub/dataset', 'celebA'), txt_file='dataset_ulub/CelebA-HQ/train.txt')
    # ub1_valid_dataset = CelebA_HQ(root=os.path.join('/data/dk/ulub/dataset', 'celebA'), txt_file='dataset_ulub/CelebA-HQ/ub1_val.txt')
    # ub2_valid_dataset = CelebA_HQ(root=os.path.join('/data/dk/ulub/dataset', 'celebA'), txt_file='dataset_ulub/CelebA-HQ/ub2_val.txt')
